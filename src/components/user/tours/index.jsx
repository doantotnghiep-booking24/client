...
function Tour() {
  ...
  const filterTours = tours.filter((tour) => {
    const checkPrice = tour.Price_Tour >= minPrice && tour.Price_Tour <= maxPrice;
    const checkTourName =
      selectedTourNames.length === 0 || selectedTourNames.includes(tour.Name_Tour);
    const checkCategory =
                ...
                >
                  ...
                  {categories.map((category, index) => (
                    <Tab
                      ...
                      sx={{
                        color: selectedTab === index + 1 ? "#3fd0d4" : "inherit",
                        "&.Mui-selected": {
                          color: "#3fd0d4",
                        },
                      }}

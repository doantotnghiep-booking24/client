                  ...
                  <Link key={tour._id} to={`/tours/${tour._id}`} style={{ textDecoration: 'none' }} className={cx("content__home-item")}>
                    ...
                    <div className={cx("section")}>
                      ...
                      <div className={cx("section__heading")}>
                        ...
                        {tour.totalReview >= 4 && tour.totalReview <= 5 ? <div className={cx("section__heading-good")}>Tốt</div> : (tour.totalReview >= 3 && tour.totalReview < 4 ? <div className={cx("section__heading-good")}>Tb</div> : (tour.totalReview >=1 && tour.totalReview <= 2 ? <div className={cx("section__heading-good")}>Tệ</div> : ''))}
                      </div>
                      {tour.totalReview > 0 && (
